                    ...
                    if (Memory.WorldToScreen(entity.Origin, out Vector2 OriginPosition2D, Viewmatrix, Overlay.Width, Overlay.Height) && Memory.WorldToScreen(entityCourched ? entity.CrouchHeadLevel : entity.HeadLevel, out Vector2 HeadPosition2D, Viewmatrix, Overlay.Width, Overlay.Height))
                    {
                        ...
                        if (Settings.Snaplines)
                            if (entity.TeamNum != LocalPlayer.TeamNum)
                            {
                                ...
                                Overlay.Line(Overlay.Width / 2, Overlay.Height, (int)OriginPosition2D.X, (int)OriginPosition2D.Y, Color.Red);
                            }
                        if (Settings.ESP)
                        {
                            if (entity.TeamNum != LocalPlayer.TeamNum)
                            {
                                ...
                                if (Settings.ESPType == Settings.BoxType.Rectangle)
                                {
                                    if (dist < 30)
                                    {
                                        Overlay.Rectangle((int)x1, (int)y1, (int)BoxWidth, (int)BoxHeight, Color.Red);
                                    }
                                    else if (dist > 30 && dist < 50) {
                                        Overlay.Rectangle((int)x1, (int)y1, (int)BoxWidth, (int)BoxHeight, Color.White);
                                    }
                                    else if (dist > 50)
                                    {
                                        Overlay.Rectangle((int)x1, (int)y1, (int)BoxWidth, (int)BoxHeight, Color.Blue);
                                    }
                                    Overlay.Circle((int)(HeadPosition2D.X), (int)HeadPosition2D.Y + 5, (int)8, Color.White, 1);
                                    Overlay.Text("Distance: " + Math.Round(dist) + " m", (int)(x1 + BoxWidth + (BoxWidth / 12)), (int)HeadPosition2D.Y, Color.White, false, false, "Arial", 5);
                                }
                                else if (Settings.ESPType == Settings.BoxType.Corner)
                                {
                                    if (dist < 30)
                                    {
                                        Overlay.CornerBox((int)x1, (int)y1, (int)BoxWidth, (int)BoxHeight, 1, Color.Red);
                                    }
                                    else if (dist > 30 && dist < 50)
                                    {
                                        Overlay.CornerBox((int)x1, (int)y1, (int)BoxWidth, (int)BoxHeight, 1, Color.White);
                                    }
                                    else if (dist > 50)
                                    {
                                        Overlay.CornerBox((int)x1, (int)y1, (int)BoxWidth, (int)BoxHeight, 1, Color.Blue);
                                    }
                                    Overlay.Circle((int)(HeadPosition2D.X), (int)HeadPosition2D.Y + 5, (int)8, Color.White, 1);
                                    Overlay.Text("Distance: " + Math.Round(dist) + " m", (int)(x1 + BoxWidth + (BoxWidth / 12)), (int)HeadPosition2D.Y, Color.White, false, false, "Arial", 5);
                                }
                        ...
                        if (Settings.HealthBar)
                        {
                            ...
                            else if (entity.Health < 50 && entity.Health > 30)
                            {
                                Overlay.Bar((int)(x1 + BoxWidth + (BoxWidth / 12)), (int)HeadPosition2D.Y, (int)(BoxWidth / 8), (int)(BoxHeight), 1, Color.FromArgb(2, 2, 2), entity.Health, 100, Color.Yellow);
                            }
                            else if (entity.Health < 30)
                            {
                                Overlay.Bar((int)(x1 + BoxWidth + (BoxWidth / 12)), (int)HeadPosition2D.Y, (int)(BoxWidth / 8), (int)(BoxHeight), 1, Color.FromArgb(2, 2, 2), entity.Health, 100, Color.Red);
                            }
                            }
                        if(Settings.Aimbot)
                        {
